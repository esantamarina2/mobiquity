...
This solutions have a time and space complexity of O(M*N) where M -> possible items and N bag capacity.
To solve the problem, decimals were removed using other unit measure in order to compare easily with the others values.
